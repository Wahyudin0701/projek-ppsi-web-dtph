<x-app-layout>
    <x-slot name="header">Jenis Program</x-slot>
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between mb-2">
            <div>
                <h3 class="text-xl font-bold text-gray-900">Jenis Program</h3>
                <p class="text-sm text-gray-500 mt-1">Kelola jenis-jenis program bantuan yang tersedia.</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50/50 border-b border-gray-100">
                            ...
                            <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100">Jenis Program</th>
                            <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100">Deskripsi</th>
                            <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100 text-center">Jumlah Program</th>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.program-categories.edit', $category) }}"
                                        ...
                                        <template x-teleport="body">
                                            <div x-show="openDelete" x-cloak class="fixed inset-0 z-[100] flex items-center justify-center bg-gray-900/50 backdrop-blur-sm px-4">
                                                <div @click.away="openDelete = false"
                                                    ...
                                                    <h3 class="text-lg font-bold text-gray-900 mb-2">Hapus Jenis Program</h3>
                                                    <p class="text-sm text-gray-500 mb-6">Anda yakin ingin menghapus jenis <span class="font-bold text-gray-900">"{{ $category->name }}"</span>? Data tidak dapat dikembalikan.</p>
                                                    ...
                                                    <div class="flex justify-center gap-3">
                                                        ...
                                                        <form action="{{ route('admin.program-categories.destroy', $category) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm">Belum ada jenis program yang ditambahkan.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
