<x-app-layout>
    <x-slot name="header">Kategori Dokumen</x-slot>
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between mb-2">
             <div>
            <h3 class="text-xl font-bold text-gray-900">Kategori Dokumen</h3>
            <p class="text-sm text-gray-500 mt-1">Kelola daftar kategori untuk Dokumen</p>
        </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50/50 border-b border-gray-100">
                            ...
                            <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100 text-center">Jumlah Dokumen</th>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm">Belum ada data kategori dokumen.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
