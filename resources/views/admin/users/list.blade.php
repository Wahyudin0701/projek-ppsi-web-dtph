                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-4">
                                        <div class="w-12 h-12 rounded-2xl bg-green-50 flex items-center justify-center text-[#19A148] font-black text-lg shadow-sm group-hover:scale-110 transition-transform">
                                            {{ substr($user->nama_kelompok, 0, 1) }}
                                        </div>
                                        <div>
                                            <div class="font-black text-gray-900 text-sm leading-tight mb-1">{{ $user->nama_kelompok }}</div>
                                            <div class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Ketua: {{ $user->ketua }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-5">
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="flex items-center gap-2 text-[11px] font-medium text-gray-400">
                                            ...
                                            <span class="truncate max-w-[150px]">{{ $user->alamat }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-5 text-center">
                                    @php
                                        ...
                                        $conf = $statusConfig[$user->status] ?? ['bg' => 'bg-gray-50', 'text' => 'text-gray-500', 'label' => 'Unknown'];
                                    @endphp
