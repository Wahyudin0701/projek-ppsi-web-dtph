                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="group hover:bg-gray-50/50 transition-colors {{ $user->farmerProfile->status === 'menunggu' ? 'bg-amber-50/30' : '' }}">
                                <td class="px-6 py-5">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span class="font-bold text-gray-900">{{ $user->farmerProfile->nama_kelompok }}</span>
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex flex-col">
                                        <span class="font-bold text-gray-800 text-sm">{{ $user->farmerProfile->ketua }}</span>
                                        <span class="text-xs text-gray-400 font-mono mt-1">{{ $user->farmerProfile->nik_ketua ?? '-' }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-5">
                                ...
                                <td class="px-6 py-5 text-center">
                                    <a href="{{ route('admin.users.show', $user) }}" 
                                       class="inline-flex items-center justify-center px-5 py-2.5 rounded-xl text-xs font-black transition-all shadow-sm
                                              {{ $user->farmerProfile->status === 'menunggu' 
