    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-6 md:p-8 border-b border-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <form action="{{ route('admin.users.umum') }}" method="GET" class="flex flex-col gap-3 w-full lg:w-auto" x-data="{ startDate: '{{ request('start_date') }}' }">
                    <div class="flex flex-col sm:flex-row gap-3 items-end">
                        ...
                        <div class="w-full sm:w-auto flex flex-col">
                            ...
                            <input type="date" name="start_date" x-model="startDate" onchange="this.form.submit()"
                                class="w-full sm:w-36 py-2 px-3 bg-gray-50 border-gray-200 rounded-xl text-sm focus:ring-green-600 focus:border-green-600 transition-all">
                        </div>
