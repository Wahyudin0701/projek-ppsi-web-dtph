    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-6 md:p-8 border-b border-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h3 class="text-xl font-bold text-gray-900">Petani Individu</h3>
                    <p class="text-sm text-gray-500 mt-1">Kelola dan pantau seluruh data petani individu atau masyarakat umum binaan DTPH Muaro Jambi.</p>
                </div>

                <form action="{{ route('admin.users.individuals') }}" method="GET" class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    {{-- Search Input --}}
                    <div class="relative w-full sm:w-64">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Cari petani individu..." 
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50/50">
                            <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100">Informasi Petani</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-500 mt-0.5">NIK: <span class="font-medium text-gray-700">{{ $user->farmerProfile->nik_ketua ?? '-' }}</span></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Belum ada petani individu yang terdaftar di dalam sistem.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
