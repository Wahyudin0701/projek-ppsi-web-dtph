...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between mb-2">
        <div>
            <h2 class="text-2xl font-extrabold text-gray-900">Tambah Kategori</h2>
            <p class="text-gray-500 text-sm mt-1">Tambahkan kategori baru untuk Alat dan Mesin Pertanian</p>
        </div>
        <a href="{{ route('admin.alsintan-categories.index') }}" class="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-blue-600 transition-colors">
    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-2xl border border-gray-100">
        <form action="{{ route('admin.alsintan-categories.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                           ...
                           placeholder="Contoh: Alat Semprot">
                    @error('name')
