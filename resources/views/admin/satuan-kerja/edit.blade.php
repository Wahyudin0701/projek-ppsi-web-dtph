                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="alamat" id="alamat" rows="3" required
                                  class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors shadow-sm">{{ old('alamat', $satuan_kerja->alamat) }}</textarea>
                    </div>
