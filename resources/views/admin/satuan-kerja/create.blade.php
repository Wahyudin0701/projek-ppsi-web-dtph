    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('admin.satuan-kerja.store') }}" method="POST" class="p-6 md:p-8">
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 flex justify-end gap-4">
                ...
                <button type="submit" class="px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg">Simpan Data</button>
            </div>
        </form>
    </div>
</x-app-layout>
