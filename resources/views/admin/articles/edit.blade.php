            ...
            <div class="md:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="summary" id="summary" rows="3" required
                        class="block w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#19A148]/20 focus:border-[#19A148] transition-all">{{ old('summary', $article->summary) }}</textarea>
                </div>
