            ...
            <div class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="jenis_tanah" placeholder="Contoh: Gambut / Mineral" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Sumber Air Budidaya</label>
                        <input type="text" name="sumber_air" placeholder="Contoh: Sungai / Sumur Bor / Tadah Hujan" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="rawan_bencana" placeholder="Contoh: Banjir / Karhutla / Aman" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Pemanfaatan Lahan Sebelumnya</label>
                        <input type="text" name="pemanfaatan_lahan_sebelumnya" placeholder="Contoh: Belukar / Kebun Sawit" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>

                    <div class="sm:col-span-2">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Pengalaman Budidaya</label>
                        <input type="text" name="pengalaman_budidaya" placeholder="Contoh: 5 Tahun bertani padi" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="petugas_dokumentasi" value="{{ old('petugas_dokumentasi') }}" placeholder="Nama Petugas Dokumentasi" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Petugas Pemetaan</label>
                        <input type="text" name="petugas_pemetaan" value="{{ old('petugas_pemetaan') }}" placeholder="Nama Petugas Pemetaan" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">No. HP Petugas Pemetaan</label>
                        <input type="text" name="no_hp_pemetaan" value="{{ old('no_hp_pemetaan') }}" placeholder="Contoh: 081234567890" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-50">
                    </div>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Foto Hasil Pemetaan Data</label>
                    ...
                    <div class="sm:col-span-2 mt-4">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Upload Dokumen Fisik CPCL (Sudah Di-TTD) *</label>
