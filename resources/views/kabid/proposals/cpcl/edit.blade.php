    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-primary-50 rounded-2xl border border-primary-200 p-6 flex gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-primary-700 mt-1">Perbarui data berdasarkan perubahan temuan di lapangan. Kosongkan unggahan foto jika tidak diubah. Beri tanda strip (-) atau angka 0 jika tak relevan. <br><span class="text-xs text-primary-600 font-medium">* Tanda bintang merah menandakan kolom wajib diisi.</span></p>
            </div>
        </div>

        <form action="{{ route('kabid.proposals.cpcl.update', $proposal) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            @csrf
            @method('PATCH')
            ...
            <div class="p-8 space-y-8">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4">
                                    <select name="status_kepemilikan" required class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                                        ...
                                        <option value="-" {{ old('status_kepemilikan', $cpcl->status_kepemilikan) == '-' || old('status_kepemilikan', $cpcl->status_kepemilikan) == 'N/A' ? 'selected' : '' }}>- (Tidak Relevan)</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="px-4 py-4">
                                    <input type="number" step="0.01" name="luas_lahan" value="{{ old('luas_lahan', $cpcl->luas_lahan) }}" required class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" placeholder="Contoh: 1.5">
                                </td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 text-gray-900 font-medium align-middle">Jenis Tanah <span class="text-red-500">*</span></td>
                                <td class="px-4 py-4">
                                    <input type="text" name="jenis_tanah" value="{{ old('jenis_tanah', $cpcl->jenis_tanah) }}" required placeholder="Contoh: Gambut / Mineral / -" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                                </td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 text-gray-900 font-medium align-middle">Sumber Air Budidaya <span class="text-red-500">*</span></td>
                                <td class="px-4 py-4">
                                    <input type="text" name="sumber_air" value="{{ old('sumber_air', $cpcl->sumber_air) }}" required placeholder="Contoh: Sungai / Sumur Bor / Tadah Hujan / -" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                                </td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 text-gray-900 font-medium align-middle">Kondisi Lahan <span class="text-red-500">*</span></td>
                                <td class="px-4 py-4">
                                    <input type="text" name="kondisi_lahan" value="{{ old('kondisi_lahan', $cpcl->kondisi_lahan) }}" required placeholder="Contoh: Rata, Bebas Banjir / Terdapat saluran irigasi baik / -" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                                </td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 text-gray-900 font-medium align-middle">Rawan Bencana <span class="text-red-500">*</span></td>
                                <td class="px-4 py-4">
                                    <input type="text" name="rawan_bencana" value="{{ old('rawan_bencana', $cpcl->rawan_bencana) }}" required placeholder="Contoh: Banjir / Karhutla / Aman / -" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                                </td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 text-gray-900 font-medium align-middle">Pemanfaatan Lahan Sebelumnya <span class="text-red-500">*</span></td>
                                <td class="px-4 py-4">
                                    <input type="text" name="pemanfaatan_lahan_sebelumnya" value="{{ old('pemanfaatan_lahan_sebelumnya', $cpcl->pemanfaatan_lahan_sebelumnya) }}" required placeholder="Contoh: Belukar / Kebun Sawit / -" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                                </td>
                            </tr>
                            <tr>
                                <td class="px-4 py-4 text-gray-900 font-medium align-middle">Pengalaman Budidaya <span class="text-red-500">*</span></td>
                                <td class="px-4 py-4">
                                    <input type="text" name="pengalaman_budidaya" value="{{ old('pengalaman_budidaya', $cpcl->pengalaman_budidaya) }}" required placeholder="Contoh: 5 Tahun bertani padi / -" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Foto Hasil Pemetaan Data (Update Opsional) <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Foto Lahan / Bukti Survei (Update Opsional) <span class="text-red-500">*</span></label>
                    ...
                    <div class="sm:col-span-2 mt-4">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Upload Dokumen Fisik CPCL (Sudah Di-TTD) (Update Opsional) <span class="text-red-500">*</span></label>
