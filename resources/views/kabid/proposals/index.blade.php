    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-6 md:p-8 border-b border-gray-50 flex flex-col gap-5">
                ...
                <form method="GET" action="{{ route('kabid.proposals.index') }}" class="flex flex-wrap gap-3 items-center" x-data="{ startDate: '{{ request('start_date') }}' }" x-ref="filterForm">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="date" name="start_date" x-model="startDate" x-on:change="$refs.filterForm.submit()" class="px-4 py-2.5 border border-gray-200 rounded-xl text-sm text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all bg-white">
                    </div>

                    <div class="flex flex-col">
                        <label class="text-xs font-bold text-gray-700 mb-1.5 ml-1">Sampai Tgl</label>
                        <input type="date" name="end_date" value="{{ request('end_date') }}" :min="startDate" x-on:change="$refs.filterForm.submit()" class="px-4 py-2.5 border border-gray-200 rounded-xl text-sm text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all bg-white">
                    </div>
