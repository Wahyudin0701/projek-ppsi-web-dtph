                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <select name="profile[afiliasi_lembaga]" id="profile_afiliasi_lembaga"
                                            ...
                                            <option value="Kelompok Tani" {{ (old('profile.afiliasi_lembaga', $user->farmerProfile->afiliasi_lembaga) == 'Kelompok Tani') ? 'selected' : '' }}>Kelompok Tani</option>
                                            <option value="Gapoktan" {{ (old('profile.afiliasi_lembaga', $user->farmerProfile->afiliasi_lembaga) == 'Gapoktan') ? 'selected' : '' }}>Gapoktan</option>
                                            <option value="UPJA" {{ (old('profile.afiliasi_lembaga', $user->farmerProfile->afiliasi_lembaga) == 'UPJA') ? 'selected' : '' }}>UPJA</option>
                                            <option value="Individu" {{ (old('profile.afiliasi_lembaga', $user->farmerProfile->afiliasi_lembaga) == 'Individu') ? 'selected' : '' }}>Individu</option>
                                            <option value="Lainnya" {{ (old('profile.afiliasi_lembaga', $user->farmerProfile->afiliasi_lembaga) == 'Lainnya') ? 'selected' : '' }}>Lainnya</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <select name="profile[komoditi_utama]" id="profile_komoditi_utama"
                                            ...
                                            <optgroup label="Tanaman Pangan">
                                                @foreach(['Padi Sawah', 'Padi Gogo', 'Jagung Hibrida', 'Kedelai', 'Kacang Tanah'] as $kom)
                                                    <option value="{{ $kom }}" {{ old('profile.komoditi_utama', $user->farmerProfile->komoditi_utama) == $kom ? 'selected' : '' }}>{{ $kom }}</option>
                                                @endforeach
                                            </optgroup>
