        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
            ...
            <div class="mb-16">
                <div class="flex items-center gap-4 mb-8">
                    <div class="flex-shrink-0 w-12 h-12 rounded-xl bg-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-600/30">
                ...
                <div class="relative bg-gradient-to-br from-emerald-600 to-green-700 rounded-2xl p-8 md:p-10 shadow-xl shadow-emerald-600/20 overflow-hidden">
                    {{-- Decorative circles --}}
                    ...
                    <div class="relative z-10">
                        <svg class="w-10 h-10 text-emerald-300/60 mb-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex gap-5 p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/40 hover:shadow-md transition-all duration-300 group">
                        <div class="flex-shrink-0 w-12 h-12 rounded-xl bg-white border-2 border-emerald-500 flex items-center justify-center group-hover:bg-emerald-600 group-hover:border-emerald-600 transition-all duration-300 shadow-sm">
                            <span class="text-sm font-extrabold text-emerald-600 group-hover:text-white transition-colors duration-300">{{ $item['no'] }}</span>
                        </div>
            ...
            <div class="mt-16 rounded-2xl bg-gray-900 text-white p-8 md:p-10 text-center relative overflow-hidden">
                <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_#059669,_transparent_70%)] opacity-40"></div>
                <div class="relative z-10">
                    <p class="text-xs font-bold uppercase tracking-widest text-emerald-400 mb-3">Motto Pelayanan</p>
