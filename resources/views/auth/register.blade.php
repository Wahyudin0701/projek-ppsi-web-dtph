    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 relative">
            ...
            <div class="lg:flex lg:items-center lg:justify-center lg:h-screen">
                ...
                {{-- Form --}}
                <form method="POST" action="{{ route('register') }}" class="space-y-5 flex-1 pb-10">
                    @csrf

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <!-- Nama Kelompok Tani -->
                        <div class="md:col-span-2">
                            <label for="name" class="block text-sm font-bold text-gray-800 mb-2">Nama Kelompok Tani</label>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nama_ketua" id="nama_ketua" value="{{ old('nama_ketua') }}" required
                                    class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#19A148]/20 focus:border-[#19A148] transition-all sm:text-sm"
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="nik_ketua" id="nik_ketua" value="{{ old('nik_ketua') }}" required
                                    class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#19A148]/20 focus:border-[#19A148] transition-all sm:text-sm"
                        ...
                        <div x-data="{ showPasswordConf: false }">
                            ...
                            <div class="relative group">
                                ...
                                <input :type="showPasswordConf ? 'text' : 'password'" name="password_confirmation" id="password_confirmation" required
                                    class="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#19A148]/20 focus:border-[#19A148] transition-all sm:text-sm"
                                    placeholder="••••••••">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="number" step="0.01" name="luas_lahan" id="luas_lahan" value="{{ old('luas_lahan') }}" required
                                    class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#19A148]/20 focus:border-[#19A148] transition-all sm:text-sm"
                    ...
                    {{-- Info Alert --}}
                    <div class="bg-blue-50/50 border border-blue-100 rounded-xl p-4 mt-6 flex items-start">
