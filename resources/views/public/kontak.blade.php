        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="lg:col-span-5 space-y-8">
                        ...
                        <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_6px_30px_-10px_rgba(0,0,0,0.04)] group hover:shadow-[0_16px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-500">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-sm font-bold text-gray-900 leading-snug">{{ \App\Models\Setting::get('contact_address', 'Komplek Perkantoran Bukit Cinto Kenang, Sengeti, Kabupaten Muaro Jambi, Jambi 36381') }}</p>
                                </div>
                            </div>
                        </div>

                        @php
                            $phoneExt = \App\Models\Setting::get('contact_phone_ext');
                        @endphp
                        @if($phoneExt)
                        {{-- Phone Card --}}
                        <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_6px_30px_-10px_rgba(0,0,0,0.04)] group hover:shadow-[0_16px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-500">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="min-w-0">
                                    <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Telepon Kantor</h3>
                                    <p class="text-sm font-bold text-gray-900 leading-snug">{{ $phoneExt }}</p>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_6px_30px_-10px_rgba(0,0,0,0.04)] group hover:shadow-[0_16px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-500">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-sm font-bold text-gray-900 leading-snug">{{ \App\Models\Setting::get('contact_email', 'kontak@dtph-muarojambi.go.id') }}</p>
                        ...
                        <div class="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_6px_30px_-10px_rgba(0,0,0,0.04)] group hover:shadow-[0_16px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-500 sm:col-span-2 lg:col-span-1">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-sm font-bold text-gray-900 leading-snug">{{ \App\Models\Setting::get('contact_hours', 'Senin — Jumat') }}</p>
                                    <p class="text-xs text-primary-600 mt-1 font-bold">{{ \App\Models\Setting::get('contact_hours_time', '08.00 - 16.00 WIB') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @php
                        ...
                        // If the number starts with 0 (like 0812), change to 62. If it's already 62, keep it.
                    ...
                    <div class="bg-primary-600 rounded-[2.5rem] p-8 text-white shadow-xl overflow-hidden relative group">
                        ...
                        <div class="flex items-center gap-4 relative z-10">
                            @if($wa)
                            <a href="{{ $wa }}" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-2xl bg-white/20 flex items-center justify-center hover:bg-white text-white hover:text-primary-600 transition-all duration-500 hover:-translate-y-1">
                            ...
                            @endif
                            @if($fb)
                            <a href="{{ $fb }}" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-2xl bg-white/20 flex items-center justify-center hover:bg-white text-white hover:text-primary-600 transition-all duration-500 hover:-translate-y-1">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                            @endif
                            @if($ig)
                            <a href="{{ $ig }}" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-2xl bg-white/20 flex items-center justify-center hover:bg-white text-white hover:text-primary-600 transition-all duration-500 hover:-translate-y-1">
                            ...
                            @endif
                            @if($tw)
                            <a href="{{ $tw }}" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-2xl bg-white/20 flex items-center justify-center hover:bg-white text-white hover:text-primary-600 transition-all duration-500 hover:-translate-y-1">
            ...
            <div class="mt-24 space-y-8">
                <div class="text-center">
                    ...
                    <p class="text-gray-500 text-sm mt-2 font-medium">Temukan kami di {{ \App\Models\Setting::get('contact_address', 'Komplek Perkantoran Bukit Cinto Kenang, Sengeti') }}.</p>
                </div>
